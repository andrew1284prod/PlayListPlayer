...
MSG = {
    "ru": {
        "start": "[Установка] Инициализация Playlist Player для Arch Linux...",
    ...
    "en": {
        "start": "[Setup] Initializing Playlist Player for Arch Linux...",
...
def run_setup():
    ...
    try:
        ...
        # 4. Алиасы с экранированием пробелов
